...
public class FileController {
	...
	@GetMapping("/information-dir")
	public ResponseEntity<List<FileOrDirectoryInformation>> getByDirectory(
			@RequestParam(name = "dir") String dir
	){
		return new ResponseEntity<>(fileInformationService.getFilesByDirectory(dir), OK);
	}
